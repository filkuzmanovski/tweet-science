# Run python twitter_time_series.py user_timeline_Lakers.jsonl 
import sys
import json
...
if __name__ == '__main__':
    ...
    with open(fname, 'r') as f:
        ...
        # Resampling in 1 minute Buckets
        ...
        datemin = datetime(2015, 12, 31, 15, 0)
        datemax = datetime(2016, 12, 31, 18, 0)
